...
parser.add_argument('--output-dir', type=Path, default=SAFETYHOOK_ROOT / 'amalgamated-dist',
                    help='Directory to write the amalgamated safetyhook.cpp and safetyhook.hpp files.')
